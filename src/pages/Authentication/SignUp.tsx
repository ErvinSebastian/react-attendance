...
const SignUp: React.FC = () => {
  ...
  const registerUser = (credentials: formDataType) => {
      ...
      if (hasUpperCase(password)) {
        if (containsNumber(password)) {
          if (password == confirmPassword) {
            ...
            setSuccessMsg(
              'Hooray! Successfully registered, Please wait for your account to be approved to log in',
            );
          } else {
            setErrorMsg('Please Check Confirm Password');
          }
        } else {
          setErrorMsg(
            'Your Password must contain atleast 8 characters with at least 1 Uppercase letter and numeric character.',
          );
        }
      } else {
        setErrorMsg(
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/4">
            <div className="">
              <p className="2xl:px-20">Qrize App</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-3/4 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium text-warning">
                {errorMsg ? errorMsg : ''}
              </span>
              <span className="mb-1.5 block font-medium text-success">
                {successMsg ? successMsg : ''}
              </span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to Qrize System
              </h2>
