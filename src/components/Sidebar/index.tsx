...
import Logo from '../../images/logo/users.svg';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-0 lg:py-0 m-0">
        <NavLink
          to="/dashboard"
